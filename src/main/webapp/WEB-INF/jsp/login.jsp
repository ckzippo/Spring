...
<head>
    ...
    <link rel="stylesheet" href="/resources/css/matrix/matrix-login.css" />
    <link href="/resources/font-awesome/css/font-awesome.css" rel="stylesheet" />
</head>
<body>
<div id="loginbox">
    <form id="loginform" class="form-vertical" action="/login/adminlogin" method="POST">
        <div class="control-group normal_text"> <h3><img src="/resources/img/logo.png" alt="Logo" /></h3></div>
        <div class="control-group">
            <div class="controls">
                <div class="main_input_box">
                    <span class="add-on bg_lg"><i class="icon icon-user"></i></span><input name="acc" type="text" placeholder="用户名" />
                </div>
            </div>
        </div>
        <div class="control-group">

                    ...
                    <div class="widget-content nopadding">
                        <form method="post" name="showDept" id="showDept">
                            ...
                            <div align="right">
                                ...
                                <a><button class="btn btn-success" onclick="adjustdept()" >调整至此节点</button></a>
                            </div>
                        </form>
                    </div>
                </div>
...
<script language="JavaScript" type="text/javascript">
    ...
    function nextlayer() {
        ...
        if (t != 1) {
            ...
            var action = "/dept/selectDept?deptid=" + deptid;
    ...
    /*将成员调整至此组织架构节点*/
    function adjustdept() {
       // var deptid = getQueryString("detpid");
        var deptid = location.href.GetValue("deptid");
        alert(deptid);
        var userid = <%=request.getSession().getAttribute(ActionEnum.ADJDEPTMEMUSERID.getActionName())%>;
        alert(userid);
        var action = "/dept/invoke?deptid=" + deptid + "&userid=" + userid;
        showDept.action = action;
        showDept.submit();
